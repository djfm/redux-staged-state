...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactBridge = __webpack_require__(4);

	Object.defineProperty(exports, 'connectStaged', {
	  enumerable: true,
	  get: function get() {
	    return _reactBridge.connectStaged;
	  }
	});

	var _stage = __webpack_require__(162);
	...
	var _accessors = __webpack_require__(3);
	...
	Object.defineProperty(exports, 'composeAccessors', {
	  enumerable: true,
	  get: function get() {
	    return _accessors.compose;
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var reducer = exports.reducer = function reducer() {
	  ...
	  if (action.type === _constants.SET_TYPE) {
	    return (0, _accessors.deserialize)(action.accessor).of(state).set(action.value);
	  }

	  if (action.type === _constants.DELETE_TYPE) {
	    return (0, _accessors.deserialize)(action.accessor).of(state).delete();
	  }
...
/***/ function(module, exports) {
	...
	var SET_TYPE = exports.SET_TYPE = '@@redux-staged-state/SET';
	var DELETE_TYPE = exports.DELETE_TYPE = '@@redux-staged-state/DELETE';
...
/***/ function(module, exports) {
	...
	var prop = exports.prop = function prop(propertyName) {
	  return {
	    serialized: propertyName,
	    of: function of(object) {
	      return {
	        get: function get() {
	          return object ? object[propertyName] : undefined;
	        },
	        set: function set(value) {
	          return Object.assign({}, object, _defineProperty({}, propertyName, value));
	        },
	...
	var nth = exports.nth = function nth(pos) {
	  return {
	    serialized: '[' + pos + ']',
	    of: function of(array) {
	      return {
	        ...
	        set: function set(value) {
	          return [].concat(array.slice(0, pos), value, array.slice(pos + 1));
	        },
	        delete: function _delete() {
	          return [].concat(array.slice(0, pos), array.slice(pos + 1));
	        }
	      };
	    }
	  };
	...
	var beforeFirst = exports.beforeFirst = function beforeFirst() {
	  return {
	...
	var afterLast = exports.afterLast = function afterLast() {
	  return {
	...
	var beforeNth = exports.beforeNth = function beforeNth(n) {
	  return {
	    ...
	    of: function of(array) {
	      return {
	        ...
	        set: function set(value) {
	          return [].concat(array.slice(0, n), value, array.slice(n));
	        },
	        delete: function _delete() {
	          return [].concat(array.slice(0, n - 1), array.slice(n));
	        }
	      };
	    }
	  };
	...
	var afterNth = exports.afterNth = function afterNth(n) {
	  return {
	    ...
	    of: function of(array) {
	      return {
	        ...
	        set: function set(value) {
	          return [].concat(array.slice(0, n + 1), value, array.slice(n + 1));
	        },
	        delete: function _delete() {
	          return [].concat(array.slice(0, n + 1), array.slice(n + 2));
	        }
	      };
	    }
	  };
	...
	var last = exports.last = function last() {
	  return {
	    serialized: '[last]',
	    of: function of(array) {
	      return nth(array.length - 1).of(array);
	    }
	  };
	};

	var deserializeAtomicAccessor = function deserializeAtomicAccessor(accessor) {
	  if (accessor === '[last]') {
	    return last();
	  }
	  ...
	  var matchesNth = /^\[(\d+)\]$/.exec(accessor);
	  if (matchesNth) {
	    return nth(+matchesNth[1]);
	  }

	  var matchesFuncWithArgs = /^\[(\w+)\((.*?)\)\]$/.exec(accessor);
	  if (matchesFuncWithArgs) {
	    var func = matchesFuncWithArgs[1];
	    var args = matchesFuncWithArgs[2].split(',').map(function (n) {
	      return +n;
	    });
	    var funcs = {
	      beforeNth: beforeNth,
	    ...
	    return funcs[func].apply(funcs, _toConsumableArray(args));
	  }
	...
	var deserialize = exports.deserialize = function deserialize(serializedAccessor) {
	  return serializedAccessor ? compose.apply(undefined, _toConsumableArray(serializedAccessor.replace(/([^.])\[/g, '$1.[').split('.').map(function (part) {
	    return deserializeAtomicAccessor(part);
	  }))) : undefined;
	};
	/* eslint-enable no-use-before-define */

	var composeSerializedAccessors = function composeSerializedAccessors(a, b) {
	  return b[0] === '[' ? a + b : a + '.' + b;
	};

	var prepareAccesor = function prepareAccesor(maybeAccessor) {
	  if (!maybeAccessor) {
	    return undefined;
	  }
	...
	var compose2 = function compose2(maybeA, maybeB) {
	  var _map = [maybeA, maybeB].map(prepareAccesor);
	    ...
	    return {
	      ...
	      of: function of(object) {
	        return {
	          ...
	          set: function set(value) {
	            return a.of(object).set(b.of(a.of(object).get()).set(value));
	          },
	          delete: function _delete() {
	            return a.of(object).set(b.of(a.of(object).get()).delete());
	          }
	        };
	      }
	    };
	...
	var compose = exports.compose = function compose(a, b) {
	  ...
	  return compose.apply(undefined, [compose2(a, b)].concat(rest));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.connectStaged = undefined;
	...
	var getPropsFromStore = function getPropsFromStore(store) {
	  var config = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];
	  return function (accessor) {
	    return (0, _stage.stage)(accessor, store.dispatch, config)(store.getState());
	  };
	};

	var mapPropsToAccessor = function mapPropsToAccessor(props, accessorCreator) {
	...
	var connectStaged = exports.connectStaged = function connectStaged(accessorCreator) {
	  var userConfig = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];
	  return function (WrappedComponent) {
	    var config = Object.assign({ stagedMountPoint: 'staged' }, userConfig);

	    var Container = function Container(props, context) {
	      return (0, _react.createElement)(WrappedComponent, Object.assign({}, props, getPropsFromStore(context.store, config)(mapPropsToAccessor(props, accessorCreator))));
	    };
	    Container.contextTypes = { store: _react2.default.PropTypes.object };
	    return Container;
	  };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ifUndefined = function ifUndefined(candidate, replacement) {
	  return candidate === undefined ? replacement : candidate;
	};

	var makeGetter = function makeGetter(rootAccessor, state) {
	...
	var makePristine = function makePristine(rootAccessor, state) {
	  var config = arguments.length <= 2 || arguments[2] === undefined ? {} : arguments[2];
	  return function (accessor) {
	    var accessorObj = (0, _accessors.compose)(rootAccessor, accessor);

	    var originalValue = accessorObj.of(state).get();
	    var stagedValue = (0, _accessors.compose)(config.stagedMountPoint, accessorObj).of(state).get();

	    return (0, _utils.deepIncludes)(originalValue)(stagedValue);
	  };
	};

	var makeSetter = function makeSetter(rootAccessor, dispatch) {
	  return function (accessor, value) {
	    return dispatch({
	      type: _constants.SET_TYPE,
	      accessor: (0, _accessors.compose)(rootAccessor, accessor).serialized,
	      value: value
	    });
	  };
	};
	...
	var makeBindings = function makeBindings(rootAccessor, dispatch, state) {
	  var config = arguments.length <= 3 || arguments[3] === undefined ? {} : arguments[3];
	  return function (accessor) {
	    var additionalHandlers = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];
	    return (0, _utils.sequenceCommonFunctions)(additionalHandlers, {
	      onChange: function onChange(event) {
	        return makeSetter(rootAccessor, dispatch)(accessor, event.target.value);
	      },
	...
	var stage = exports.stage = function stage(rootAccessor, dispatch, config) {
...
/***/ function(module, exports) {
	...
	var sequenceCommonFunctions = exports.sequenceCommonFunctions = function sequenceCommonFunctions(first, then) {
	  var newThen = {};

	  var _loop = function _loop(k) {
	    if (k in first) {
	      newThen[k] = function () {
	        first[k].apply(first, arguments);
	        return then[k].apply(then, arguments);
	      };
	    } else {
	      newThen[k] = then[k];
	    }
